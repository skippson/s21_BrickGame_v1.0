...
/**
 * @brief Обозначение налево
 */
#define LEFT -1

/**
 * @brief Обозначение направо
 */
#define RIGHT 1
 ...
 * @param game Структура игры
 * @param move Действие над тетрамино
 ...
 * @param inddex Индекс массива(значение скорости)
